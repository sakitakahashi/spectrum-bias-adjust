...
model {
	...
	// Likelihood part 1a: intercepts for group 1
	for (j in 1:J_1) {
	...
	// Likelihood part 1b: intercepts for group 2
	for (j in 1:J_2) {
...
generated quantities {
	...
	matrix<lower=0.0, upper=1.0>[8,(DAYS_FOR_SENS+1)] sensitivity_over_time;	// Sensitivity: 2 classes of severity x 4 possible outcomes (++, +-, -+, --)
